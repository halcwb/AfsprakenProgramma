VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmMedicament 
   Caption         =   "Kies een medicament ..."
   ClientHeight    =   6426
   ClientLeft      =   42
   ClientTop       =   329
   ClientWidth     =   12397
   OleObjectBlob   =   "frmMedicament.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmMedicament"
...
Dim intN As Integer
Dim objMedicament As clsMedicatieDiscontinue
Dim objFormularium As clsFormularium
...
Private Sub LoadMedicament(objMedicament As clsMedicatieDiscontinue)
...
Private Sub UserForm_Initialize()
    ...
    Set objFormularium = New clsFormularium
