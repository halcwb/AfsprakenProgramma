VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmPatient 
   Caption         =   "Nieuwe patient"
   ClientHeight    =   3318
   ClientLeft      =   42
   ClientTop       =   329
   ClientWidth     =   7308
   OleObjectBlob   =   "frmPatient.frx":0000
...
Private Sub txtGebDat_BeforeUpdate(ByVal Cancel As MSForms.ReturnBoolean)
    On Error GoTo Hell
...
Private Sub txtOpnDat_BeforeUpdate(ByVal Cancel As MSForms.ReturnBoolean)
...
Private Sub txtLengte_BeforeUpdate(ByVal Cancel As MSForms.ReturnBoolean)
...
Private Sub txtGew_BeforeUpdate(ByVal Cancel As MSForms.ReturnBoolean)
...
Private Sub txtGew_KeyPress(ByVal KeyAscii As MSForms.ReturnInteger)
