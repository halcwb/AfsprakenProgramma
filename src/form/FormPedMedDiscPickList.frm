VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} FormPedMedDiscPickList 
   Caption         =   "Kies medicamenten"
   ClientHeight    =   7125
   ClientLeft      =   15
   ClientTop       =   315
   ClientWidth     =   5835
   OleObjectBlob   =   "FormPedMedDiscPickList.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "FormPedMedDiscPickList"
...
Private Const constMaxSelected As Integer = 30
...
Public Sub SelectMedicament(ByVal strItem As String)

    Dim intN As Integer

    intN = ModList.GetItemIndex(Me.lstMedicamenten, strItem) + 2
    ModList.SelectListItem lstMedicamenten, intN

End Sub

Public Function IsMedicamentSelected(ByVal strItem As String) As Boolean
...
Public Sub UnselectMedicament(ByVal strItem As String)
...
Public Function GetFirstSelectedMedicament(ByVal blnUnSelect As Boolean) As String
